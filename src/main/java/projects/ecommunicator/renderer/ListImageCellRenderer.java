 ...
 */
package projects.ecommunicator.renderer;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ListImageCellRenderer extends JLabel implements ListCellRenderer {

	public static final int OFFSET = 16;
	protected Color textSelectionColor = Color.white;
	protected Color textNonSelectionColor = Color.black;
	protected Color textNonselectableColor = Color.black;
	...
	public Component getListCellRendererComponent(
		...
		if (obj instanceof PresentationInfoListData) {
			PresentationInfoListData ldata = (PresentationInfoListData) obj;
		...
		textColor =
			(sel
				? textSelectionColor
				: (selectable ? textNonSelectionColor : textNonselectableColor));
