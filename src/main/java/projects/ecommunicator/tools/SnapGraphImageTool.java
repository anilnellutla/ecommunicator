 ...
 * @version 1.0
 */
public class SnapGraphImageTool extends ScreenShotImage {
	...
	public String getToolString() {
		...
		try {
			File tempFile = File.createTempFile("SnapGraphShot", ".png", null);
		...
		String toolString =
			Utility.convertTo4Byte(ScoolConstants.SNAP_GRAPH_SHOT_TOOL)
