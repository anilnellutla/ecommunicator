...
/**
 * This is a sub class of AbstractAction that sets the WhiteBoardCanvas tool as FREE_HAND_TOOL
 * <P>
...
public class FreeHandAction extends AbstractAction {
	...
	*/
	public FreeHandAction(WhiteBoardCanvas canvas) {
		this.canvas = canvas;
	}
	...
	*/
	public void actionPerformed(ActionEvent e) {		
		...
		canvas.setDrawTool(ScoolConstants.FREE_HAND_TOOL);
	}
}